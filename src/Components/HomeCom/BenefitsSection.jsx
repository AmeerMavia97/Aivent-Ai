...
const BenefitsSection = () => {
    return (
        <section className='flex flex-col justify-center items-center bg-blue py-20 pb-32'>
            ...
            <div className='grid grid-cols-2 gap-10 place-content-center mt-10'>
                ...
                {CardData.map((items, index) => (
                 <div key={items.id} className="relative group w-[570px] h-[370px] overflow-hidden rounded-[12px]  cursor-pointer card ">
