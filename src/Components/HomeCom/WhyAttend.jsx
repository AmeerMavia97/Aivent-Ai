...
export default function GlobalNetworkingCard() {
  return (
    <>
      <section className="px-8 sm:px-20 py-20 bg-blue">
        <div className="flex flex-col justify-center items-center ">
          <div className='flex flex-col justify-center items-center gap-3 text-center'>
            
            <h1 data-aos="fade-up" data-aos-delay="300" className="bg-[linear-gradient(0deg,#888888_0%,#ffffff_55%)] bg-clip-text text-transparent font-bold text-[35px] sm:text-4xl  md:text-6xl lg:text-[48px]  leading-[45px] sm:leading-[56px]">
             Conoce nuestra oferta de Diplomados:
            </h1>

            <p data-aos="fade-up" data-aos-delay="300" className='text-[#ffffffda] font-Manrope text-[16px] font-[500] leading-[28px] sm:w-[60%] '>
