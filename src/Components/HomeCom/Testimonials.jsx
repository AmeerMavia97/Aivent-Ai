...
const Testimonials = () => {
    return (
        <section className='relative overflow-hidden px-20 py-40 bg-blue  flex justify-center flex-col items-center
            ...
            <div className='flex relative z-50 py-10 max-w-[1200px] '>
                <div className='relative w-[36%]'>
                    <div data-aos="img-gutter-only" 
  data-aos-duration="1000" ><Image  width={310} height={450} className='rounded-[9px]' src={"/assets/s9.webp"} alt="testimonial" /></div>
                    <div data-aos="fade-left" className='bg-skyBlue absolute px-4 rounded-[10px] top-4 right-16 py-4'>
                        <Quote className='size-10 text-white' />
                    </div>
                </div>

                <div data-aos="fade-up" className='w-[64%] flex flex-col justify-center'>
