    ...
    return (
        <section className='relative overflow-hidden px-8 sm:px-20 py-20 sm::py-32  bg-blue  flex justify-center items-center
            ...
            <div data-aos="zoom-out" className='flex flex-col justify-center items-center gap-5 relative z-50 py-10 text-center max-w-[1200px] '>
                ...
                <h1 className="bg-[linear-gradient(0deg,#888888_0%,#ffffff_55%)] bg-clip-text text-transparent font-bold text-[32px] leading-[38px] md:text-6xl lg:text-[48px]  sm:leading-[56px] sm:w-[80%]">
