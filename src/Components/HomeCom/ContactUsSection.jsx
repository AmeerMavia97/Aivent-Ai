...
const ContactUsSection = () => {
    return (
        <>
            <section className='bg-blue relative overflow-hidden flex justify-center px-16'>
                <div className=' py-20 pt-28 grid grid-cols-2  max-w-[1200px] 
                '>
                    <div className='flex flex-col justify-center gap-6 '>
                        <div className='flex flex-col justify-center gap-6'>
                            ...
                            <p  data-aos="fade-up" data-aos-delay="600" className='text-[#ffffffda] font-Manrope text-[16px] font-[500] leading-[28px] w-[80%] '>
                    ...
                    <div className='px-5'>
                        ...
                        <form data-aos="zoom-out-down" className='bg-[#5676f617] rounded-[7px] px-10 py-20' action="">
