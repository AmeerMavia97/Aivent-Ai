...
const ServiceSection = () => {
    return (
        <>
            <section className='bg-blue px-16 pt-10 pb-24'>
                <div className='flex'>
                    <div className='flex flex-col justify-center gap-6 w-[65%]'>
                        <h1 className="bg-[linear-gradient(0deg,#888888_0%,#ffffff_55%)] bg-clip-text text-transparent font-bold text-4xl  md:text-6xl lg:text-[43px]  leading-[56px]">
                    ...
                    <div className='flex justify-end pr-2 w-[35%]'>
                ...
                <div className='mt-12'>
                    ...
                    <div className='grid grid-cols-4 gap-4 px-1'>
                        {MiniCardItems.map(item => (
                            <div key={item.id} className='flex flex-col gap-2 justify-center items-center py-9 px-8 rounded-[8px] border border-[#e3e3e349] bg-[#444d5a19]'>
                                <Image alt='icons' src={item.img} width={37} height={37} />
